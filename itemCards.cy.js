...
//     // Click the itemcard button on the page
    // cy.get('[class=" tab_btn"]').contains('Item Cards').click().wait(200)
    // cy.dragAndDrop('player_detail_card', 'item_card', 0)
    ...
    //         if (currentUrl.includes('/team-complete')) {
